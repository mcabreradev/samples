...
class User_schools_majors_model extends MY_Model {

	protected $table = 'user_schools_majors';
	protected $primary_key = 'user_school_major_id';
  ...
  public function getWithUserId($user_school_major_id, $user_id) {
    $this->db->select('user_schools_majors.*, user_schools.user_id');
    $this->db->join('user_schools', 'user_schools.user_school_id = user_schools_majors.user_school_major_id');
